...
def update_speed(row_speed: float, column_speed: float, rows_direction: int, columns_direction: int,
                 row_speed_limit: float = 2.0, column_speed_limit: float = 2.0, fading: float = 0.8) \
        -> Tuple[float, float]:
